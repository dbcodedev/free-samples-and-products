import { ResourcePicker, Toast, Loading } from "@shopify/app-bridge-react";
import { Banner, Button, Card, Checkbox, FormLayout, Heading, Icon, Layout, Page, PageActions, TextContainer, TextField } from "@shopify/polaris";
...
export function Settings() {
    ...
    if (error) {
      console.warn(error);
      return (
        <Banner status="critical">There was an issue loading data.</Banner>
      );
    }
