                    ...
                    >
                        <FormLayout>
                            <TextField 
                                ...
                                type="number"
                                value={userSettings.maxProductsByUser}
                            ...
                            <TextField 
                                ...
                                type="number"
                                value={userSettings.maxReferenceByUser}
                                onChange={(value, id) => handleUpdateSettings(value, id)} 
                            />
                        </FormLayout>
                    </Layout.AnnotatedSection>
                    ...
                    >
                        <FormLayout>
                            <TextField 
                                ...
                                type="number"
                                value={userSettings.maxProducts}
                                onChange={(value, id) => handleUpdateSettings(value, id)} 
                            />
                            <Checkbox 
                                id="displayRandomly" 
                                label="Display products randomly" 
                                checked={userSettings.displayRandomly} 
                                onChange={(value, id) => handleUpdateSettings(value, id)}
                            />
                            <Checkbox 
                                id="hideOutOfStock" 
                                label="Hide products out of stock" 
                                checked={userSettings.hideOutOfStock} 
                                onChange={(value, id) => handleUpdateSettings(value, id)}
                            />
                        </FormLayout>
                    </Layout.AnnotatedSection>
                    ...
                    >
                        <FormLayout>
                            <TextField 
                                ...
                                type="number" 
                                value={userSettings.minCartProducts}
                                onChange={(value, id) => handleUpdateSettings(value, id)}  
                            />
                            <TextField 
                                id="minCartAmount" 
                                ...
                                type="number" 
                                value={userSettings.minCartAmount}
                                onChange={(value, id) => handleUpdateSettings(value, id)}  
                            />
                            <Card >
